...
function showConvertInputModalChaimae(newType, newTypeLabel, prefillNumero = '', prefillBonLivraison = '') {
...
window.convertInvoiceTypeChaimae = async function(invoiceId, currentType) {
    ...
    document.getElementById('confirmConvert').onclick = async () => {
        ...
        try {
            ...
            const inputData = await showConvertInputModalChaimae(newType, newTypeLabel, currentNumero, prefillBonLivraison);
