                ...
                <div class="login-container-desktop">
                    ...
                    <div class="login-form-container">
                        ...
                        <div style="margin-top: 2rem; text-align: center; border-top: 1px solid #3e3e42; padding-top: 1rem;">
                            <a href="#" onclick="(function(e){e.preventDefault();var u=localStorage.getItem('API_BASE_URL')||'https://redouan.ddns.net/facture';window.open(u.replace(/\/api$/,'')+'/','_blank');})(event)" style="color: #2196f3; text-decoration: none; font-size: 0.9rem; display: flex; align-items: center; justify-content: center; gap: 0.5rem;">
