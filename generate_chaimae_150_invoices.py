...
def create_invoice(conn, year, sequential_id):
    """Create an invoice for CHAIMAE company"""
    cursor = conn.cursor()
    ...
    doc_type = random.choice(['facture', 'facture', 'bon_livraison', 'bon_commande'])
...
def main():
    print("🚀 Génération de 150 factures pour CHAIMAE...")
    ...
    try:
        ...
        conn.close()
        print(f"\n🎉 Total: {total_created} factures créées pour CHAIMAE!")
